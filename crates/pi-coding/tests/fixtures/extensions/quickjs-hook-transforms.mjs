// Every handler returns a reduction the host applies through its reduce_* /
// emit machinery. The return shapes are the authoritative hook semantics
// shared with process-hosted extensions.
