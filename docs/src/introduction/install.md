...
```powershell
irm https://raw.githubusercontent.com/0x8f701/rpi/v0.2.5/install.ps1 -OutFile install.ps1
powershell -ExecutionPolicy Bypass -File ./install.ps1 -Version v0.2.5
```
